...
<a id="12.16.2"></a>
## 2020-03-24, Version 12.16.2 'Erbium' (LTS), @codebytere
...
* [[`ef635e4de4`](https://github.com/nodejs/node/commit/ef635e4de4)] - **assert**: align character indicators properly (Ruben Bridgewater) [#31429](https://github.com/nodejs/node/pull/31429)
...
* [[`b03692e91e`](https://github.com/nodejs/node/commit/b03692e91e)] - **benchmark**: remove problematic tls params (Brian White) [#31816](https://github.com/nodejs/node/pull/31816)
* [[`8538494922`](https://github.com/nodejs/node/commit/8538494922)] - **benchmark**: use let instead of var (Daniele Belardi) [#31592](https://github.com/nodejs/node/pull/31592)
* [[`6e54536db0`](https://github.com/nodejs/node/commit/6e54536db0)] - **benchmark**: swap var for let in benchmarks (Alex Ramirez) [#28958](https://github.com/nodejs/node/pull/28958)
* [[`6b74b10a75`](https://github.com/nodejs/node/commit/6b74b10a75)] - **benchmark**: remove special test entries (Ruben Bridgewater) [#31396](https://github.com/nodejs/node/pull/31396)
* [[`0b372617ec`](https://github.com/nodejs/node/commit/0b372617ec)] - **benchmark**: refactor helper into a class (Ruben Bridgewater) [#31396](https://github.com/nodejs/node/pull/31396)
* [[`c21fb89d9e`](https://github.com/nodejs/node/commit/c21fb89d9e)] - **benchmark**: check for and fix multiple end() (Brian White) [#31624](https://github.com/nodejs/node/pull/31624)
* [[`1caf98f813`](https://github.com/nodejs/node/commit/1caf98f813)] - **benchmark**: clean up config resolution in multiple benchmarks (Denys Otrishko) [#31581](https://github.com/nodejs/node/pull/31581)
* [[`5a146bdead`](https://github.com/nodejs/node/commit/5a146bdead)] - **benchmark**: add MessagePort benchmark (Anna Henningsen) [#31568](https://github.com/nodejs/node/pull/31568)
* [[`46cc34d8a0`](https://github.com/nodejs/node/commit/46cc34d8a0)] - **benchmark**: use let and const instead of var (Daniele Belardi) [#31518](https://github.com/nodejs/node/pull/31518)
...
* [[`0238b2dfb7`](https://github.com/nodejs/node/commit/0238b2dfb7)] - **buffer**: improve from() performance (Brian White) [#31615](https://github.com/nodejs/node/pull/31615)
* [[`6d1c6996b5`](https://github.com/nodejs/node/commit/6d1c6996b5)] - **buffer**: improve concat() performance (Brian White) [#31522](https://github.com/nodejs/node/pull/31522)
...
* [[`da9371e3ff`](https://github.com/nodejs/node/commit/da9371e3ff)] - **build**: allow use of system-installed brotli (André Draszik) [#32046](https://github.com/nodejs/node/pull/32046)
* [[`aea6535b3a`](https://github.com/nodejs/node/commit/aea6535b3a)] - **build**: allow passing multiple libs to pkg\_config (André Draszik) [#32046](https://github.com/nodejs/node/pull/32046)
* [[`8249c3b30f`](https://github.com/nodejs/node/commit/8249c3b30f)] - **build**: enable backtrace when V8 is built for PPC and S390x (Michaël Zasso) [#32113](https://github.com/nodejs/node/pull/32113)
* [[`776b13252f`](https://github.com/nodejs/node/commit/776b13252f)] - **build**: add asan check in Github action (gengjiawen) [#31902](https://github.com/nodejs/node/pull/31902)
* [[`ec75b61b57`](https://github.com/nodejs/node/commit/ec75b61b57)] - **build**: only lint markdown files that have changed (POSIX-only) (Rich Trott) [#31923](https://github.com/nodejs/node/pull/31923)
* [[`a2e32673b5`](https://github.com/nodejs/node/commit/a2e32673b5)] - **build**: add configure option to debug only Node.js part of the binary (Anna Henningsen) [#31644](https://github.com/nodejs/node/pull/31644)
* [[`fa7f9bafc7`](https://github.com/nodejs/node/commit/fa7f9bafc7)] - **build**: ignore all the "Debug","Release" folders (ConorDavenport) [#31565](https://github.com/nodejs/node/pull/31565)
* [[`f5262a4e90`](https://github.com/nodejs/node/commit/f5262a4e90)] - **build**: fix zlib tarball generation (Shelley Vohr) [#32094](https://github.com/nodejs/node/pull/32094)
...
* [[`53a29da9c3`](https://github.com/nodejs/node/commit/53a29da9c3)] - **cli**: --perf-prof only works on Linux (Shelley Vohr) [#31892](https://github.com/nodejs/node/pull/31892)
* [[`801050ba0c`](https://github.com/nodejs/node/commit/801050ba0c)] - **crypto**: turn impossible DH errors into assertions (Tobias Nießen) [#31934](https://github.com/nodejs/node/pull/31934)
* [[`0042e3ea31`](https://github.com/nodejs/node/commit/0042e3ea31)] - **crypto**: fix ieee-p1363 for createVerify (Tobias Nießen) [#31876](https://github.com/nodejs/node/pull/31876)
* [[`9e06d8f2e2`](https://github.com/nodejs/node/commit/9e06d8f2e2)] - **crypto**: fix performance regression (Robert Nagy) [#31742](https://github.com/nodejs/node/pull/31742)
* [[`54da1958f2`](https://github.com/nodejs/node/commit/54da1958f2)] - **crypto**: improve randomBytes() performance (Brian White) [#31519](https://github.com/nodejs/node/pull/31519)
* [[`53305deb11`](https://github.com/nodejs/node/commit/53305deb11)] - **deps**: V8: backport f7771e5b0cc4 (Matheus Marchini) [#31957](https://github.com/nodejs/node/pull/31957)
* [[`382fd8b916`](https://github.com/nodejs/node/commit/382fd8b916)] - **deps**: openssl: cherry-pick 4dcb150ea30f (Adam Majer) [#32002](https://github.com/nodejs/node/pull/32002)
* [[`5f866e44f1`](https://github.com/nodejs/node/commit/5f866e44f1)] - **deps**: update zlib to upstream d7f3ca9 (Sam Roberts) [#31800](https://github.com/nodejs/node/pull/31800)
* [[`8de377dc63`](https://github.com/nodejs/node/commit/8de377dc63)] - **deps**: move zlib maintenance info to guides (Sam Roberts) [#31800](https://github.com/nodejs/node/pull/31800)
* [[`b8e86a587d`](https://github.com/nodejs/node/commit/b8e86a587d)] - **deps**: upgrade npm to 6.13.7 (Michael Perrotte) [#31558](https://github.com/nodejs/node/pull/31558)
* [[`402e54c712`](https://github.com/nodejs/node/commit/402e54c712)] - **deps**: switch to chromium's zlib implementation (Brian White) [#31201](https://github.com/nodejs/node/pull/31201)
...
* [[`d4b11c56fb`](https://github.com/nodejs/node/commit/d4b11c56fb)] - **doc**: link setRawMode() from signal docs (Anna Henningsen) [#32088](https://github.com/nodejs/node/pull/32088)
* [[`4386332355`](https://github.com/nodejs/node/commit/4386332355)] - **doc**: document self-referencing a package name (Gil Tayar) [#31680](https://github.com/nodejs/node/pull/31680)
* [[`c21861a058`](https://github.com/nodejs/node/commit/c21861a058)] - **doc**: add AsyncResource + Worker pool example (Anna Henningsen) [#31601](https://github.com/nodejs/node/pull/31601)
* [[`0606e1d2f1`](https://github.com/nodejs/node/commit/0606e1d2f1)] - **doc**: document fs.watchFile() bigint option (Colin Ihrig) [#32128](https://github.com/nodejs/node/pull/32128)
* [[`3b71ce127c`](https://github.com/nodejs/node/commit/3b71ce127c)] - **doc**: fix broken links in benchmark README (Rich Trott) [#32121](https://github.com/nodejs/node/pull/32121)
* [[`72d52c78bd`](https://github.com/nodejs/node/commit/72d52c78bd)] - **doc**: update email address in authors (Yael Hermon) [#32026](https://github.com/nodejs/node/pull/32026)
* [[`21afb19bdb`](https://github.com/nodejs/node/commit/21afb19bdb)] - **doc**: update maintaining-V8.md (kenzo-spaulding) [#31503](https://github.com/nodejs/node/pull/31503)
* [[`db9857d499`](https://github.com/nodejs/node/commit/db9857d499)] - **doc**: visibility of Worker threads cli options (Harshitha KP) [#31380](https://github.com/nodejs/node/pull/31380)
* [[`22a71de632`](https://github.com/nodejs/node/commit/22a71de632)] - **doc**: improve doc/markdown file organization coherence (ConorDavenport) [#31792](https://github.com/nodejs/node/pull/31792)
* [[`2bd8d99bee`](https://github.com/nodejs/node/commit/2bd8d99bee)] - **doc**: revise --zero-fill-buffers text in buffer.md (Rich Trott) [#32019](https://github.com/nodejs/node/pull/32019)
* [[`b15bf35246`](https://github.com/nodejs/node/commit/b15bf35246)] - **doc**: add link to sem-ver info (unknown) [#31985](https://github.com/nodejs/node/pull/31985)
* [[`87fc9cbcdf`](https://github.com/nodejs/node/commit/87fc9cbcdf)] - **doc**: update zlib doc (James M Snell) [#31665](https://github.com/nodejs/node/pull/31665)
* [[`ce1c681a8c`](https://github.com/nodejs/node/commit/ce1c681a8c)] - **doc**: clarify http2.connect authority details (James M Snell) [#31828](https://github.com/nodejs/node/pull/31828)
* [[`45a36375dc`](https://github.com/nodejs/node/commit/45a36375dc)] - **doc**: updated YAML version representation in readline.md (Rich Trott) [#31924](https://github.com/nodejs/node/pull/31924)
* [[`6fe592ef5a`](https://github.com/nodejs/node/commit/6fe592ef5a)] - **doc**: describe how to update zlib (Sam Roberts) [#31800](https://github.com/nodejs/node/pull/31800)
* [[`d70f0520b3`](https://github.com/nodejs/node/commit/d70f0520b3)] - **doc**: update releases guide re pushing tags (Myles Borins) [#31855](https://github.com/nodejs/node/pull/31855)
* [[`f9c2835b37`](https://github.com/nodejs/node/commit/f9c2835b37)] - **doc**: update assert.rejects() docs with a validation function example (Eric Eastwood) [#31271](https://github.com/nodejs/node/pull/31271)
* [[`570b4f853d`](https://github.com/nodejs/node/commit/570b4f853d)] - **doc**: add note about ssh key to releases (Shelley Vohr) [#31856](https://github.com/nodejs/node/pull/31856)
* [[`b5b0dc921e`](https://github.com/nodejs/node/commit/b5b0dc921e)] - **doc**: add note in BUILDING.md about running `make distclean` (Swagat Konchada) [#31542](https://github.com/nodejs/node/pull/31542)
* [[`73ceb20384`](https://github.com/nodejs/node/commit/73ceb20384)] - **doc**: reword possessive form of Node.js in adding-new-napi-api.md (Rich Trott) [#31748](https://github.com/nodejs/node/pull/31748)
* [[`0ee43523ed`](https://github.com/nodejs/node/commit/0ee43523ed)] - **doc**: reword possessive form of Node.js in http.md (Rich Trott) [#31748](https://github.com/nodejs/node/pull/31748)
* [[`265f8c02c8`](https://github.com/nodejs/node/commit/265f8c02c8)] - **doc**: reword possessive form of Node.js in process.md (Rich Trott) [#31748](https://github.com/nodejs/node/pull/31748)
* [[`b4804e9f44`](https://github.com/nodejs/node/commit/b4804e9f44)] - **doc**: reword possessive form of Node.js in debugger.md (Rich Trott) [#31748](https://github.com/nodejs/node/pull/31748)
* [[`b8e51a20d6`](https://github.com/nodejs/node/commit/b8e51a20d6)] - **doc**: move gireeshpunathil to TSC emeritus (Gireesh Punathil) [#31770](https://github.com/nodejs/node/pull/31770)
* [[`e2071f3226`](https://github.com/nodejs/node/commit/e2071f3226)] - **doc**: pronouns for @Fishrock123 (Jeremiah Senkpiel) [#31725](https://github.com/nodejs/node/pull/31725)
* [[`2c20f734d3`](https://github.com/nodejs/node/commit/2c20f734d3)] - **doc**: move @Fishrock123 to TSC Emeriti (Jeremiah Senkpiel) [#31725](https://github.com/nodejs/node/pull/31725)
* [[`eaf2feee86`](https://github.com/nodejs/node/commit/eaf2feee86)] - **doc**: move @Fishrock123 to a previous releaser (Jeremiah Senkpiel) [#31725](https://github.com/nodejs/node/pull/31725)
* [[`99165b0834`](https://github.com/nodejs/node/commit/99165b0834)] - **doc**: fix typos in doc/api/https.md (Jeff) [#31793](https://github.com/nodejs/node/pull/31793)
* [[`693b5d65d6`](https://github.com/nodejs/node/commit/693b5d65d6)] - **doc**: guide - using valgrind to debug memory leaks (Michael Dawson) [#31501](https://github.com/nodejs/node/pull/31501)
* [[`832d8a584b`](https://github.com/nodejs/node/commit/832d8a584b)] - **doc**: add glossary.md (gengjiawen) [#27517](https://github.com/nodejs/node/pull/27517)
* [[`524d429499`](https://github.com/nodejs/node/commit/524d429499)] - **doc**: add prerequisites information for Arch (Ujjwal Sharma) [#31669](https://github.com/nodejs/node/pull/31669)
* [[`bbbb7d8d38`](https://github.com/nodejs/node/commit/bbbb7d8d38)] - **doc**: fix typo on fs docs (Juan José Arboleda) [#31620](https://github.com/nodejs/node/pull/31620)
* [[`19363949a3`](https://github.com/nodejs/node/commit/19363949a3)] - **doc**: update contact email for @ryzokuken (Ujjwal Sharma) [#31670](https://github.com/nodejs/node/pull/31670)
* [[`8cacabd3d9`](https://github.com/nodejs/node/commit/8cacabd3d9)] - **doc**: fix default server timeout description for https (Andrey Pechkurov) [#31692](https://github.com/nodejs/node/pull/31692)
* [[`e791941938`](https://github.com/nodejs/node/commit/e791941938)] - **doc**: add directions to mark a release line as lts (Danielle Adams) [#31724](https://github.com/nodejs/node/pull/31724)
* [[`67a5b05262`](https://github.com/nodejs/node/commit/67a5b05262)] - **doc**: expand C++ README with information about exception handling (Anna Henningsen) [#31720](https://github.com/nodejs/node/pull/31720)
* [[`d783eff49a`](https://github.com/nodejs/node/commit/d783eff49a)] - **doc**: update foundation name in onboarding (Tobias Nießen) [#31719](https://github.com/nodejs/node/pull/31719)
* [[`b358f80bf1`](https://github.com/nodejs/node/commit/b358f80bf1)] - **doc**: reword possessive form of Node.js in zlib.md (Rich Trott) [#31713](https://github.com/nodejs/node/pull/31713)
* [[`3e113db098`](https://github.com/nodejs/node/commit/3e113db098)] - **doc**: reword possessive form of Node.js in modules.md (Rich Trott) [#31713](https://github.com/nodejs/node/pull/31713)
* [[`239e2cb84c`](https://github.com/nodejs/node/commit/239e2cb84c)] - **doc**: reword possessive form of Node.js in repl.md (Rich Trott) [#31713](https://github.com/nodejs/node/pull/31713)
* [[`c5992c8f6f`](https://github.com/nodejs/node/commit/c5992c8f6f)] - **doc**: reword section title in addons.md (Rich Trott) [#31713](https://github.com/nodejs/node/pull/31713)
* [[`9821d936ee`](https://github.com/nodejs/node/commit/9821d936ee)] - **doc**: revise deepEqual() legacy assertion mode text (Rich Trott) [#31704](https://github.com/nodejs/node/pull/31704)
* [[`6e79a17039`](https://github.com/nodejs/node/commit/6e79a17039)] - **doc**: improve strict assertion mode color text (Rich Trott) [#31703](https://github.com/nodejs/node/pull/31703)
* [[`4b0c1a5804`](https://github.com/nodejs/node/commit/4b0c1a5804)] - **doc**: consolidate introductory text (Rich Trott) [#31667](https://github.com/nodejs/node/pull/31667)
* [[`8f8fd4d47d`](https://github.com/nodejs/node/commit/8f8fd4d47d)] - **doc**: simplify async\_hooks overview (Rich Trott) [#31660](https://github.com/nodejs/node/pull/31660)
* [[`8dfa3fe548`](https://github.com/nodejs/node/commit/8dfa3fe548)] - **doc**: clarify Worker exit/message event ordering (Anna Henningsen) [#31642](https://github.com/nodejs/node/pull/31642)
* [[`e174b9e430`](https://github.com/nodejs/node/commit/e174b9e430)] - **doc**: update TSC name in "Release Process" (Tobias Nießen) [#31652](https://github.com/nodejs/node/pull/31652)
* [[`aeadd6863a`](https://github.com/nodejs/node/commit/aeadd6863a)] - **doc**: remove .github/ISSUE\_TEMPLATE.md in favor of the template folder (Joyee Cheung) [#31656](https://github.com/nodejs/node/pull/31656)
* [[`be896083d8`](https://github.com/nodejs/node/commit/be896083d8)] - **doc**: correct getting an ArrayBuffer's length (tsabolov) [#31632](https://github.com/nodejs/node/pull/31632)
* [[`ea4f266efd`](https://github.com/nodejs/node/commit/ea4f266efd)] - **doc**: ask more questions in the bug report template (Joyee Cheung) [#31611](https://github.com/nodejs/node/pull/31611)
* [[`a563f1425b`](https://github.com/nodejs/node/commit/a563f1425b)] - **doc**: add example to fs.promises.readdir (Conor ONeill) [#31552](https://github.com/nodejs/node/pull/31552)
* [[`4753fa0c9b`](https://github.com/nodejs/node/commit/4753fa0c9b)] - **doc**: fix numbering (Steffen) [#31575](https://github.com/nodejs/node/pull/31575)
* [[`0ae5b02f2b`](https://github.com/nodejs/node/commit/0ae5b02f2b)] - **doc**: clarify socket.setNoDelay() explanation (Rusty Conover) [#31541](https://github.com/nodejs/node/pull/31541)
* [[`a07880fac2`](https://github.com/nodejs/node/commit/a07880fac2)] - **doc**: clarify require() OS independence (Denys Otrishko) [#31571](https://github.com/nodejs/node/pull/31571)
* [[`0a1e7df02b`](https://github.com/nodejs/node/commit/0a1e7df02b)] - **doc**: add protocol option in http2.connect() (Michael Lumish) [#31560](https://github.com/nodejs/node/pull/31560)
* [[`b6de2713b8`](https://github.com/nodejs/node/commit/b6de2713b8)] - **doc**: clarify that `v8.serialize()` is not deterministic (Anna Henningsen) [#31548](https://github.com/nodejs/node/pull/31548)
* [[`096e425c5c`](https://github.com/nodejs/node/commit/096e425c5c)] - **doc**: update job reference in COLLABORATOR\_GUIDE.md (Richard Lau) [#31557](https://github.com/nodejs/node/pull/31557)
* [[`c8798a6264`](https://github.com/nodejs/node/commit/c8798a6264)] - **doc**: simultaneous blog and email of sec announce (Sam Roberts) [#31483](https://github.com/nodejs/node/pull/31483)
* [[`173376e358`](https://github.com/nodejs/node/commit/173376e358)] - **doc**: update collaborator guide citgm instructions (Robert Nagy) [#31549](https://github.com/nodejs/node/pull/31549)
* [[`d79af926ba`](https://github.com/nodejs/node/commit/d79af926ba)] - **doc**: change error message testing policy (Tobias Nießen) [#31421](https://github.com/nodejs/node/pull/31421)
* [[`10c22add38`](https://github.com/nodejs/node/commit/10c22add38)] - **doc**: remove redundant properties from headers (XhmikosR) [#31492](https://github.com/nodejs/node/pull/31492)
...
* [[`b4d81b90a3`](https://github.com/nodejs/node/commit/b4d81b90a3)] - **doc,assert**: rename "mode" to "assertion mode" (Rich Trott) [#31635](https://github.com/nodejs/node/pull/31635)
* [[`5b10791a07`](https://github.com/nodejs/node/commit/5b10791a07)] - **doc,crypto**: re-document oaepLabel option (Ben Noordhuis) [#31825](https://github.com/nodejs/node/pull/31825)
* [[`081d4c2e48`](https://github.com/nodejs/node/commit/081d4c2e48)] - **doc,net**: reword Unix domain path paragraph in net.md (Rich Trott) [#31684](https://github.com/nodejs/node/pull/31684)
...
* [[`98b628e5a6`](https://github.com/nodejs/node/commit/98b628e5a6)] - **doc,util**: revise util.md introductory paragraph (Rich Trott) [#31685](https://github.com/nodejs/node/pull/31685)
...
* [[`392ebbf412`](https://github.com/nodejs/node/commit/392ebbf412)] - **events**: fix removeListener for Symbols (zfx) [#31847](https://github.com/nodejs/node/pull/31847)
* [[`3ce4db26f5`](https://github.com/nodejs/node/commit/3ce4db26f5)] - **fs**: fix valid id range on chown, lchown, fchown (himself65) [#31694](https://github.com/nodejs/node/pull/31694)
* [[`8622ee06eb`](https://github.com/nodejs/node/commit/8622ee06eb)] - **fs**: set path when mkdir recursive called on file (Benjamin Coe) [#31607](https://github.com/nodejs/node/pull/31607)
* [[`d113a5bf53`](https://github.com/nodejs/node/commit/d113a5bf53)] - **fs**: bail on permission error in recursive directory creation (Benjamin Coe) [#31505](https://github.com/nodejs/node/pull/31505)
...
* [[`3a77c7e2b4`](https://github.com/nodejs/node/commit/3a77c7e2b4)] - **http2**: make compat finished match http/1 (Robert Nagy) [#24347](https://github.com/nodejs/node/pull/24347)
...
* [[`53d592aeb6`](https://github.com/nodejs/node/commit/53d592aeb6)] - **meta**: move thefourtheye to TSC Emeritus (Rich Trott) [#32059](https://github.com/nodejs/node/pull/32059)
* [[`57a2d954da`](https://github.com/nodejs/node/commit/57a2d954da)] - **meta**: move not-an-aardvark to emeritus (Rich Trott) [#31928](https://github.com/nodejs/node/pull/31928)
* [[`7f679095ad`](https://github.com/nodejs/node/commit/7f679095ad)] - **meta**: move aqrln to emeritus (Rich Trott) [#31997](https://github.com/nodejs/node/pull/31997)
* [[`0ffea8716e`](https://github.com/nodejs/node/commit/0ffea8716e)] - **meta**: move jbergstroem to emeritus (Rich Trott) [#31996](https://github.com/nodejs/node/pull/31996)
* [[`b6b1c163e0`](https://github.com/nodejs/node/commit/b6b1c163e0)] - **meta**: move maclover7 to Emeritus (Rich Trott) [#31994](https://github.com/nodejs/node/pull/31994)
* [[`bf21e5b147`](https://github.com/nodejs/node/commit/bf21e5b147)] - **meta**: move Glen Keane to Collaborator Emeritus (Rich Trott) [#31993](https://github.com/nodejs/node/pull/31993)
* [[`382d904838`](https://github.com/nodejs/node/commit/382d904838)] - **meta**: move julianduque to emeritus (Rich Trott) [#31863](https://github.com/nodejs/node/pull/31863)
* [[`f9b4a8655d`](https://github.com/nodejs/node/commit/f9b4a8655d)] - **meta**: move eljefedelrodeodeljefe to emeritus (Rich Trott) [#31735](https://github.com/nodejs/node/pull/31735)
* [[`2ae5aff20a`](https://github.com/nodejs/node/commit/2ae5aff20a)] - **meta**: move princejwesley to emeritus (Rich Trott) [#31730](https://github.com/nodejs/node/pull/31730)
* [[`3dbb4a5207`](https://github.com/nodejs/node/commit/3dbb4a5207)] - **meta**: move vkurchatkin to emeritus (Rich Trott) [#31729](https://github.com/nodejs/node/pull/31729)
* [[`3a340686e5`](https://github.com/nodejs/node/commit/3a340686e5)] - **meta**: move calvinmetcalf to emeritus (Rich Trott) [#31736](https://github.com/nodejs/node/pull/31736)
* [[`c1cba92079`](https://github.com/nodejs/node/commit/c1cba92079)] - **meta**: fix collaborator list errors in README.md (James M Snell) [#31655](https://github.com/nodejs/node/pull/31655)
* [[`9680fd4370`](https://github.com/nodejs/node/commit/9680fd4370)] - **n-api**: free instance data as reference (Gabriel Schulhof) [#31638](https://github.com/nodejs/node/pull/31638)
* [[`b6822ab630`](https://github.com/nodejs/node/commit/b6822ab630)] - **n-api**: rename 'promise' parameter to 'value' (Tobias Nießen) [#31544](https://github.com/nodejs/node/pull/31544)
...
* [[`40f57da3ce`](https://github.com/nodejs/node/commit/40f57da3ce)] - **net**: track state of setNoDelay() and prevent unnecessary system calls (Rusty Conover) [#31543](https://github.com/nodejs/node/pull/31543)
* [[`eaa730c61c`](https://github.com/nodejs/node/commit/eaa730c61c)] - **src**: Handle bad callback in asyc\_wrap (Harshitha KP) [#31946](https://github.com/nodejs/node/pull/31946)
* [[`e8fdb40cf4`](https://github.com/nodejs/node/commit/e8fdb40cf4)] - **src**: add node\_crypto\_common and refactor (James M Snell) [#32016](https://github.com/nodejs/node/pull/32016)
* [[`8618929cba`](https://github.com/nodejs/node/commit/8618929cba)] - **src**: enable `StreamPipe` for generic `StreamBase`s (Anna Henningsen) [#31869](https://github.com/nodejs/node/pull/31869)
* [[`b5101e41bc`](https://github.com/nodejs/node/commit/b5101e41bc)] - **src**: elevate v8 namespaces (Harshitha KP) [#31901](https://github.com/nodejs/node/pull/31901)
* [[`f66627c1c9`](https://github.com/nodejs/node/commit/f66627c1c9)] - **src**: allow unique\_ptrs with custom deleter in memory tracker (Anna Henningsen) [#31870](https://github.com/nodejs/node/pull/31870)
* [[`ce9df9b846`](https://github.com/nodejs/node/commit/ce9df9b846)] - **src**: move BaseObject subclass dtors/ctors out of node\_crypto.h (Anna Henningsen) [#31872](https://github.com/nodejs/node/pull/31872)
* [[`9ca5787588`](https://github.com/nodejs/node/commit/9ca5787588)] - **src**: don't run bootstrapper in CreateEnvironment (Shelley Vohr) [#31910](https://github.com/nodejs/node/pull/31910)
* [[`7eb9770495`](https://github.com/nodejs/node/commit/7eb9770495)] - **src**: prefer 3-argument Array::New() (Anna Henningsen) [#31775](https://github.com/nodejs/node/pull/31775)
* [[`ccc602683f`](https://github.com/nodejs/node/commit/ccc602683f)] - **src**: use hex not decimal in IsArrayIndex (Shelley Vohr) [#31758](https://github.com/nodejs/node/pull/31758)
* [[`76edc7c8da`](https://github.com/nodejs/node/commit/76edc7c8da)] - **src**: wrap HostPort in ExclusiveAccess (Ben Noordhuis) [#31717](https://github.com/nodejs/node/pull/31717)
* [[`182b06c5fb`](https://github.com/nodejs/node/commit/182b06c5fb)] - **src**: add ExclusiveAccess class (Ben Noordhuis) [#31717](https://github.com/nodejs/node/pull/31717)
* [[`f08e0dd193`](https://github.com/nodejs/node/commit/f08e0dd193)] - **src**: allow to reuse env options handling (Denys Otrishko) [#31711](https://github.com/nodejs/node/pull/31711)
* [[`9d8b752b56`](https://github.com/nodejs/node/commit/9d8b752b56)] - **src**: fix compile warnings in node\_url.cc (Anna Henningsen) [#31689](https://github.com/nodejs/node/pull/31689)
* [[`78367e7402`](https://github.com/nodejs/node/commit/78367e7402)] - **src**: modernized unique\_ptr construction (Yuhanun Citgez) [#31654](https://github.com/nodejs/node/pull/31654)
* [[`641183f581`](https://github.com/nodejs/node/commit/641183f581)] - **src**: remove dead code in InternalMakeCallback (Gerhard Stoebich) [#31622](https://github.com/nodejs/node/pull/31622)
* [[`99eebeee71`](https://github.com/nodejs/node/commit/99eebeee71)] - **src**: remove fixed-size GetHumanReadableProcessName (Ben Noordhuis) [#31633](https://github.com/nodejs/node/pull/31633)
* [[`fb53a83c77`](https://github.com/nodejs/node/commit/fb53a83c77)] - **src**: fix OOB reads in process.title getter (Ben Noordhuis) [#31633](https://github.com/nodejs/node/pull/31633)
* [[`7b41368c5e`](https://github.com/nodejs/node/commit/7b41368c5e)] - **src**: various minor improvements to node\_url (James M Snell) [#31651](https://github.com/nodejs/node/pull/31651)
* [[`bab2bbdcd6`](https://github.com/nodejs/node/commit/bab2bbdcd6)] - **src**: fix inspecting `MessagePort` from `init` async hook (Anna Henningsen) [#31600](https://github.com/nodejs/node/pull/31600)
* [[`f434c8c2d7`](https://github.com/nodejs/node/commit/f434c8c2d7)] - **src**: remove unused `Worker::child\_port\_` member (Anna Henningsen) [#31599](https://github.com/nodejs/node/pull/31599)
* [[`da9e71b6bf`](https://github.com/nodejs/node/commit/da9e71b6bf)] - **src**: change Fill() to use ParseArrayIndex() (ConorDavenport) [#31591](https://github.com/nodejs/node/pull/31591)
* [[`9e2ceab5ce`](https://github.com/nodejs/node/commit/9e2ceab5ce)] - **src**: remove duplicate field env in CryptoJob class (ConorDavenport) [#31554](https://github.com/nodejs/node/pull/31554)
* [[`29d1cc69c3`](https://github.com/nodejs/node/commit/29d1cc69c3)] - **src**: fix console debug output on Windows (Denys Otrishko) [#31580](https://github.com/nodejs/node/pull/31580)
* [[`1dc78b2d1b`](https://github.com/nodejs/node/commit/1dc78b2d1b)] - **src**: remove preview for heap dump utilities (Anna Henningsen) [#31570](https://github.com/nodejs/node/pull/31570)
* [[`96add18e13`](https://github.com/nodejs/node/commit/96add18e13)] - **src**: fix debug crash handling null strings (Rusty Conover) [#31523](https://github.com/nodejs/node/pull/31523)
...
* [[`af1fcbe9a5`](https://github.com/nodejs/node/commit/af1fcbe9a5)] - **test**: increase test timeout to prevent flakiness (Ruben Bridgewater) [#31716](https://github.com/nodejs/node/pull/31716)
* [[`fa8d736b6e`](https://github.com/nodejs/node/commit/fa8d736b6e)] - **test**: use index.js if package.json "main" is empty (Ben Noordhuis) [#32040](https://github.com/nodejs/node/pull/32040)
* [[`60f63f1e0f`](https://github.com/nodejs/node/commit/60f63f1e0f)] - **test**: changed function to arrow function (ProdipRoy89) [#32045](https://github.com/nodejs/node/pull/32045)
* [[`e827b8eee6`](https://github.com/nodejs/node/commit/e827b8eee6)] - **test**: allow EAI\_FAIL in test-net-dns-error.js (Vita Batrla) [#31780](https://github.com/nodejs/node/pull/31780)
* [[`583faa44ea`](https://github.com/nodejs/node/commit/583faa44ea)] - **test**: remove superfluous checks in test-net-reconnect-error (Rich Trott) [#32120](https://github.com/nodejs/node/pull/32120)
* [[`9cb6d23a32`](https://github.com/nodejs/node/commit/9cb6d23a32)] - **test**: apply camelCase in test-net-reconnect-error (Rich Trott) [#32120](https://github.com/nodejs/node/pull/32120)
* [[`48eb02f165`](https://github.com/nodejs/node/commit/48eb02f165)] - **test**: update tests for larger Buffers (Jakob Kummerow) [#32114](https://github.com/nodejs/node/pull/32114)
* [[`aafc871495`](https://github.com/nodejs/node/commit/aafc871495)] - **test**: remove common.port from test-tls-securepair-client (Rich Trott) [#32024](https://github.com/nodejs/node/pull/32024)
* [[`3f0d0021a4`](https://github.com/nodejs/node/commit/3f0d0021a4)] - **test**: add WASI test for path\_link() (Colin Ihrig) [#32132](https://github.com/nodejs/node/pull/32132)
* [[`1e70542e9f`](https://github.com/nodejs/node/commit/1e70542e9f)] - **test**: move test-inspector-module to parallel (Rich Trott) [#32025](https://github.com/nodejs/node/pull/32025)
* [[`2d3926c70d`](https://github.com/nodejs/node/commit/2d3926c70d)] - **test**: fix flaky test-dns-any.js (Rich Trott) [#32017](https://github.com/nodejs/node/pull/32017)
* [[`3cea8fcf0a`](https://github.com/nodejs/node/commit/3cea8fcf0a)] - **test**: fix flaky test-gc-net-timeout (Robert Nagy) [#31918](https://github.com/nodejs/node/pull/31918)
* [[`b8bd974ff7`](https://github.com/nodejs/node/commit/b8bd974ff7)] - **test**: change test to not be sensitive to buffer send size (Rusty Conover) [#31499](https://github.com/nodejs/node/pull/31499)
* [[`252fc0a716`](https://github.com/nodejs/node/commit/252fc0a716)] - **test**: remove sequential/test-https-keep-alive-large-write.js (Rusty Conover) [#31499](https://github.com/nodejs/node/pull/31499)
* [[`8e57090d2f`](https://github.com/nodejs/node/commit/8e57090d2f)] - **test**: validate common property usage (Denys Otrishko) [#31933](https://github.com/nodejs/node/pull/31933)
* [[`c74fdef6e0`](https://github.com/nodejs/node/commit/c74fdef6e0)] - **test**: fix usage of invalid common properties (Denys Otrishko) [#31933](https://github.com/nodejs/node/pull/31933)
* [[`3adcac03cb`](https://github.com/nodejs/node/commit/3adcac03cb)] - **test**: increase timeout in vm-timeout-escape-queuemicrotask (Denys Otrishko) [#31966](https://github.com/nodejs/node/pull/31966)
* [[`8c81d05212`](https://github.com/nodejs/node/commit/8c81d05212)] - **test**: add documentation for common.enoughTestCpu (Rich Trott) [#31931](https://github.com/nodejs/node/pull/31931)
* [[`9d701071ff`](https://github.com/nodejs/node/commit/9d701071ff)] - **test**: fix typo in common/index.js (Rich Trott) [#31931](https://github.com/nodejs/node/pull/31931)
* [[`e5ebbd6230`](https://github.com/nodejs/node/commit/e5ebbd6230)] - **test**: remove common.PORT from assorted pummel tests (Rich Trott) [#31897](https://github.com/nodejs/node/pull/31897)
* [[`58b2f8629d`](https://github.com/nodejs/node/commit/58b2f8629d)] - **test**: remove flaky designation for test-net-connect-options-port (Rich Trott) [#31841](https://github.com/nodejs/node/pull/31841)
* [[`3f93b5ed4c`](https://github.com/nodejs/node/commit/3f93b5ed4c)] - **test**: remove common.PORT from test-net-write-callbacks.js (Rich Trott) [#31839](https://github.com/nodejs/node/pull/31839)
* [[`76512e137f`](https://github.com/nodejs/node/commit/76512e137f)] - **test**: remove common.PORT from test-net-pause (Rich Trott) [#31749](https://github.com/nodejs/node/pull/31749)
* [[`150d1f1d44`](https://github.com/nodejs/node/commit/150d1f1d44)] - **test**: remove common.PORT from test-tls-server-large-request (Rich Trott) [#31749](https://github.com/nodejs/node/pull/31749)
* [[`8fc91afad5`](https://github.com/nodejs/node/commit/8fc91afad5)] - **test**: remove common.PORT from test-net-throttle (Rich Trott) [#31749](https://github.com/nodejs/node/pull/31749)
* [[`d0b38ea565`](https://github.com/nodejs/node/commit/d0b38ea565)] - **test**: remove common.PORT from test-net-timeout (Rich Trott) [#31749](https://github.com/nodejs/node/pull/31749)
* [[`a223c2bbbc`](https://github.com/nodejs/node/commit/a223c2bbbc)] - **test**: add known issue test for sync writable callback (James M Snell) [#31756](https://github.com/nodejs/node/pull/31756)
* [[`e6229c0009`](https://github.com/nodejs/node/commit/e6229c0009)] - **test**: mark test-fs-stat-bigint flaky on FreeBSD (Rich Trott) [#31728](https://github.com/nodejs/node/pull/31728)
* [[`317a8aa7fd`](https://github.com/nodejs/node/commit/317a8aa7fd)] - **test**: improve test-fs-stat-bigint (Rich Trott) [#31726](https://github.com/nodejs/node/pull/31726)
* [[`84c83d18fd`](https://github.com/nodejs/node/commit/84c83d18fd)] - **test**: remove flaky designation for test-fs-stat-bigint (Rich Trott) [#30437](https://github.com/nodejs/node/pull/30437)
* [[`c9a6c7806e`](https://github.com/nodejs/node/commit/c9a6c7806e)] - **test**: fix flaky test-fs-stat-bigint (Duncan Healy) [#30437](https://github.com/nodejs/node/pull/30437)
* [[`759b03abf6`](https://github.com/nodejs/node/commit/759b03abf6)] - **test**: add debugging output to test-net-listen-after-destroy-stdin (Rich Trott) [#31698](https://github.com/nodejs/node/pull/31698)
* [[`8bb78d3fc2`](https://github.com/nodejs/node/commit/8bb78d3fc2)] - **test**: improve assertion message in test-dns-any (Rich Trott) [#31697](https://github.com/nodejs/node/pull/31697)
* [[`e0918d277c`](https://github.com/nodejs/node/commit/e0918d277c)] - **test**: stricter assert color test (Ruben Bridgewater) [#31429](https://github.com/nodejs/node/pull/31429)
* [[`76991fb0d4`](https://github.com/nodejs/node/commit/76991fb0d4)] - **test**: fix test-benchmark-http (Rich Trott) [#31686](https://github.com/nodejs/node/pull/31686)
* [[`896690d2ac`](https://github.com/nodejs/node/commit/896690d2ac)] - **test**: fix flaky test-inspector-connect-main-thread (Anna Henningsen) [#31637](https://github.com/nodejs/node/pull/31637)
* [[`cdc6255c94`](https://github.com/nodejs/node/commit/cdc6255c94)] - **test**: add test-dns-promises-lookupService (Rich Trott) [#31640](https://github.com/nodejs/node/pull/31640)
* [[`502f42c4b2`](https://github.com/nodejs/node/commit/502f42c4b2)] - **test**: fix flaky test-http2-stream-destroy-event-order (Anna Henningsen) [#31610](https://github.com/nodejs/node/pull/31610)
* [[`d3b82e67ff`](https://github.com/nodejs/node/commit/d3b82e67ff)] - **test**: unset NODE\_OPTIONS for cctest (Anna Henningsen) [#31594](https://github.com/nodejs/node/pull/31594)
* [[`3303b31b73`](https://github.com/nodejs/node/commit/3303b31b73)] - **test**: simplify test-https-simple.js (Sam Roberts) [#31584](https://github.com/nodejs/node/pull/31584)
* [[`8c5fd5aee9`](https://github.com/nodejs/node/commit/8c5fd5aee9)] - **test**: mark additional tests as flaky on Windows (Anna Henningsen) [#31606](https://github.com/nodejs/node/pull/31606)
* [[`18184bbc7f`](https://github.com/nodejs/node/commit/18184bbc7f)] - **test**: remove --experimental-worker flag comment (Harshitha KP) [#31563](https://github.com/nodejs/node/pull/31563)
* [[`9f69683ecd`](https://github.com/nodejs/node/commit/9f69683ecd)] - **test**: make test-http2-buffersize more correct (Anna Henningsen) [#31502](https://github.com/nodejs/node/pull/31502)
...
* [[`8afe620c2e`](https://github.com/nodejs/node/commit/8afe620c2e)] - **test,benchmark**: fix test-benchmark-zlib (Rich Trott) [#31538](https://github.com/nodejs/node/pull/31538)
* [[`b2aca1b3d9`](https://github.com/nodejs/node/commit/b2aca1b3d9)] - **test,dns**: add coverage for dns exception (Rich Trott) [#31678](https://github.com/nodejs/node/pull/31678)
* [[`71e9c30603`](https://github.com/nodejs/node/commit/71e9c30603)] - **tls**: reduce memory copying and number of BIO buffer allocations (Rusty Conover) [#31499](https://github.com/nodejs/node/pull/31499)
...
* [[`e635b53a9f`](https://github.com/nodejs/node/commit/e635b53a9f)] - **tools**: add NODE\_TEST\_NO\_INTERNET to the doc builder (Joyee Cheung) [#31849](https://github.com/nodejs/node/pull/31849)
* [[`15b1597608`](https://github.com/nodejs/node/commit/15b1597608)] - **tools**: sync gyp code base with node-gyp repo (Michaël Zasso) [#30563](https://github.com/nodejs/node/pull/30563)
* [[`327dbcfdd1`](https://github.com/nodejs/node/commit/327dbcfdd1)] - **tools**: update lint-md task to lint for possessives of Node.js (Rich Trott) [#31862](https://github.com/nodejs/node/pull/31862)
* [[`c739d02795`](https://github.com/nodejs/node/commit/c739d02795)] - **tools**: update Markdown linter to be cross-platform (Derek Lewis) [#31239](https://github.com/nodejs/node/pull/31239)
* [[`82b3591eb8`](https://github.com/nodejs/node/commit/82b3591eb8)] - **tools**: replace deprecated iteritems() for items() (Giovanny Andres Gongora Granada (Gioyik)) [#31528](https://github.com/nodejs/node/pull/31528)
...
* [[`466890392d`](https://github.com/nodejs/node/commit/466890392d)] - **tty**: do not end in an infinite warning recursion (Ruben Bridgewater) [#31429](https://github.com/nodejs/node/pull/31429)
* [[`de86e1a578`](https://github.com/nodejs/node/commit/de86e1a578)] - **util**: throw if unreachable TypedArray checking code is reached (Rich Trott) [#31737](https://github.com/nodejs/node/pull/31737)
* [[`db79242d4f`](https://github.com/nodejs/node/commit/db79242d4f)] - **util**: add coverage for util.inspect.colors alias setter (Rich Trott) [#31743](https://github.com/nodejs/node/pull/31743)
* [[`b8e1d52771`](https://github.com/nodejs/node/commit/b8e1d52771)] - **util**: throw if unreachable code is reached (Rich Trott) [#31712](https://github.com/nodejs/node/pull/31712)
...
* [[`5af11df4e4`](https://github.com/nodejs/node/commit/5af11df4e4)] - **worker**: emit runtime error on loop creation failure (Harshitha KP) [#31621](https://github.com/nodejs/node/pull/31621)
* [[`bd2ddc1bb0`](https://github.com/nodejs/node/commit/bd2ddc1bb0)] - **worker**: unroll file extension regexp (Anna Henningsen) [#31779](https://github.com/nodejs/node/pull/31779)
* [[`ff6c8d9417`](https://github.com/nodejs/node/commit/ff6c8d9417)] - **worker**: add support for .cjs extension (Antoine du HAMEL) [#31662](https://github.com/nodejs/node/pull/31662)
* [[`d8373a1377`](https://github.com/nodejs/node/commit/d8373a1377)] - **worker**: properly handle env and NODE\_OPTIONS in workers (Denys Otrishko) [#31711](https://github.com/nodejs/node/pull/31711)
* [[`592a494dc8`](https://github.com/nodejs/node/commit/592a494dc8)] - **worker**: reset `Isolate` stack limit after entering `Locker` (Anna Henningsen) [#31593](https://github.com/nodejs/node/pull/31593)
* [[`14d6d0df92`](https://github.com/nodejs/node/commit/14d6d0df92)] - **worker**: remove redundant closing of child port (aaccttrr) [#31555](https://github.com/nodejs/node/pull/31555)
